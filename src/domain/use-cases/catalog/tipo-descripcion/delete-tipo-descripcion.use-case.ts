...
export class DeleteTipoDescripcionUseCase {
    constructor(private readonly repository: TipoDescripcionRepository) {}

     execute(idTipoDescripcion: string): Promise<TipoDescripcionEntity> {
      return this.repository.deleteById(idTipoDescripcion);
    }
  }